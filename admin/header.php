        ...
        <div class="sidebar">
            ...
            <div class="sidebar__menu">
                <ul class="menu__sub1">
                    ...
                    <li><a href="#banners"><i class="fas fa-scroll"></i></i> Banners<i class="fa-solid fa-chevron-down"></i></a>
                        <ul class="menu__sub2">
                            <li><a href="index.php?act=listbanners"><i style="color: #009674;" class="fa-solid fa-minus"></i>Danh sách Banners</a></li>
                            <li><a href="index.php?act=addbanners"><i style="color: #009674;" class="fa-solid fa-minus"></i>Thêm banners</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
