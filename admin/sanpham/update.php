    ...
    <form class="sub__content__table" action="index.php?act=updatesp" method="post" enctype="multipart/form-data">
      ...
      <div class="sub__content__title">
        ...
        <select name="soluong" id="">
            <option value="1" <?= isset($soluong) && $soluong == 1 ? 'selected' : '' ?>>Còn hàng</option>
            <option value="0" <?= isset($soluong) && $soluong == 0 ? 'selected' : '' ?>>Hết hàng</option>
        </select>
      </div>
      
      <div class="sub__content__title">
        <p>Trạng thái sản phẩm</p>
        <select name="hien_thi" id="">
            <option value="1" <?= isset($hien_thi) && $hien_thi == 1 ? 'selected' : '' ?>>Hiển thị</option>
            <option value="0" <?= isset($hien_thi) && $hien_thi == 0 ? 'selected' : '' ?>>Ẩn</option>
        </select>
      </div>
