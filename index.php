    ...
    switch ($act) {
        ...
        case 'addtocart':
            if (isset($_POST['addtocart']) && ($_POST['addtocart'])) {
                ...
                $price = $_POST['price'];
                $soluong = 1;
                $ttien = intval($soluong) * floatval($price);
        ...
        case 'giamsp':
            ...
            if ($_SESSION['mycart'][$idcart][4] > 1) {
                $_SESSION['mycart'][$idcart][4] -= 1;
            } else {
        ...
        case 'tangsp':
            $idcart = intval($_GET['idcart']);
            $_SESSION['mycart'][$idcart][4] += 1; // Increase quantity
            header('Location: index.php?act=viewcart');
            break;
