...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th8 15, 2024 lúc 05:47 PM
...
CREATE TABLE `binhluan` (
  ...
  `status` tinyint(4) NOT NULL DEFAULT 1 COMMENT '1. Đang hiện\r\n0. Đang ẩn'
...
CREATE TABLE `sanpham` (
  ...
  `Ram` tinyint(100) NOT NULL DEFAULT 1 COMMENT '1. 8BG\r\n2. 16GB\r\n3. 32GB',
  `Color` tinyint(100) NOT NULL DEFAULT 1 COMMENT '1. Đen 2. Trắng 3. Xám 4. Đỏ 5. Tím 6. Xanh Dương	',
  `soluong` tinyint(4) NOT NULL DEFAULT 1 COMMENT '1. Còn hàng\r\n0. Hết hàng',
  `hien_thi` tinyint(4) NOT NULL DEFAULT 1 COMMENT '1. Đang hiện 0. Đang ẩn',
