...
-- Dumping database structure for sunao-pc
CREATE DATABASE IF NOT EXISTS `sunao-pc` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `sunao-pc`;

-- Dumping structure for table sunao-pc.banners
CREATE TABLE IF NOT EXISTS `banners` (
  ...
  `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '1. Đang hiện\r\n0. Đang ẩn',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table sunao-pc.banners: ~7 rows (approximately)
INSERT INTO `banners` (`id`, `title`, `description`, `image`, `link`, `status`) VALUES
	(7, 'Siêu sale giữa năm, chào hè cực chất', '', 'banner_1.webp', '', 1),
	(8, '', '', 'banner_2.webp', '', 1),
	(9, '', '', 'banner_3.webp', '', 1),
	(10, '', '', 'banner_4.webp', '', 1),
	(11, '', '', 'banner_5.webp', '', 1),
...
CREATE TABLE IF NOT EXISTS `bill` (
  ...
  `recelve_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `recelve_address` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `recelve_tel` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1004 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table sunao-pc.bill: ~2 rows (approximately)
INSERT INTO `bill` (`id`, `iduser`, `bill_user`, `bill_address`, `bill_tel`, `bill_email`, `bill_pttt`, `ngaydathang`, `total`, `bill_status`, `recelve_name`, `recelve_address`, `recelve_tel`) VALUES
	(1002, 1, 'songtinhcam3', 'HCM', '12345678999', 'ngoduong323447@gmail.com', 2, '2024-08-15 07:05:01', 12753, 5, NULL, NULL, NULL),
	(1003, 1, 'songtinhcam3', 'HCM', '12345678999', 'ngoduong323447@gmail.com', 1, '2024-08-15 16:13:41', 3328, 0, NULL, NULL, NULL);

-- Dumping structure for table sunao-pc.binhluan
CREATE TABLE IF NOT EXISTS `binhluan` (
  `id` int NOT NULL AUTO_INCREMENT,
  `noidung` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `iduser` int NOT NULL,
  `idpro` int NOT NULL,
  `ngaybinhluan` varchar(40) COLLATE utf8mb4_general_ci NOT NULL,
  `status` tinyint NOT NULL DEFAULT '1' COMMENT '1. Đang hiện\r\n0. Đang ẩn',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1005 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Dumping data for table sunao-pc.binhluan: ~1 rows (approximately)
INSERT INTO `binhluan` (`id`, `noidung`, `iduser`, `idpro`, `ngaybinhluan`, `status`) VALUES
	(1004, 'dởm', 1, 1, '07:56:22am 15/08/2024', 0);

-- Dumping structure for table sunao-pc.cart
CREATE TABLE IF NOT EXISTS `cart` (
  ...
  KEY `idpro` (`idpro`),
  KEY `iduser` (`iduser`),
  CONSTRAINT `cart_ibfk_1` FOREIGN KEY (`idbill`) REFERENCES `bill` (`id`),
  CONSTRAINT `cart_ibfk_2` FOREIGN KEY (`idpro`) REFERENCES `sanpham` (`id`),
  CONSTRAINT `cart_ibfk_3` FOREIGN KEY (`iduser`) REFERENCES `taikhoan` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1008 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table sunao-pc.cart: ~7 rows (approximately)
INSERT INTO `cart` (`id`, `iduser`, `idpro`, `img`, `name`, `price`, `soluong`, `thanhtien`, `idbill`) VALUES
	(1001, 1, 1, 'sp-laptop-MACBOOK-1.webp', 'Macbook Pro 14 M2 Pro 10CPU', 1912, 1, 1912, 1002),
	(1002, 1, 7, 'sp-laptop-gaming-MSI-stealth-1.webp', 'Laptop gaming MSI Stealth 18 AI Studio', 3738, 1, 3738, 1002),
	(1003, 1, 2, 'sp-laptop-gaming-ASUS-1.jpg', 'Laptop gaming  ASUS ROG Strix SCAR 15', 2596, 1, 2596, 1002),
	(1004, 1, 2, 'sp-laptop-gaming-ASUS-1.jpg', 'Laptop gaming  ASUS ROG Strix SCAR 15', 2596, 1, 2596, 1002),
	(1005, 1, 1, 'sp-laptop-MACBOOK-1.webp', 'Macbook Pro 14 M2 Pro 10CPU', 1912, 1, 1912, 1002),
	(1006, 1, 4, 'sp-laptop-gaming-ASUS-tuf-1.webp', 'Laptop gaming ASUS TUF Gaming F15', 1416, 5, 1416, 1003),
	(1007, 1, 1, 'sp-laptop-MACBOOK-1.webp', 'Macbook Pro 14 M2 Pro 10CPU', 1912, 1, 1912, 1003);

-- Dumping structure for table sunao-pc.danhmuc
...
-- Dumping data for table sunao-pc.danhmuc: ~9 rows (approximately)
...
-- Dumping structure for table sunao-pc.sanpham
...
-- Dumping data for table sunao-pc.taikhoan: ~2 rows (approximately)
