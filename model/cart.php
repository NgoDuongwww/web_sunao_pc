...
function viewcart($del)
{
    ...
    foreach ($_SESSION['mycart'] as $cart) {
        ...
        $ttien = floatval($cart[3]) * intval($cart[4]);
        $tong += $ttien;
        ...
        echo '
            <tr>
                ...
                <td>
                    <a href="index.php?act=giamsp&idcart=' . $i . '"><input type="button" value="-"></a>
                    ' . $cart[4] . '
                    <a href="index.php?act=tangsp&idcart=' . $i . '"><input type="button" value="+"></a>
                </td>
